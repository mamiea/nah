...
client.on('message', msg => {
  if (msg.content === '=ownerbot') {
    msg.reply('**OwnerBot <@409093271592370186>**');
  }
});
...
client.on("message", message => {
 if (message.content === "=support") {
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .setFooter('© hypixel3rb جميع الحقوق محفوظة 2018 لــبوت')
      .addField('سيرفر الدعم الفني', `https://discord.gg/bT539c`)
  message.author.send({embed});
      message.channel.send(":white_check_mark: | Check Your DM تم الأرسال بلخاص")
 }
});
...
const TOKEN = "NDg1MTkyNTgwODAwMzE1NDAz.DncneA.yHCdpgi5VkUc_dXzHrlhutyFJDw";
...
client.on('guildCreate', guild => {
  client.channels.get("490434459007713283").send(`:white_check_mark: **تم اضافة البوت في سيرفر جديد مبروكك
...
client.on('guildDelete', guild => {
  client.channels.get("490434459007713283").send(`:negative_squared_cross_mark: **طردوني حرام والله ايش سويت انا
Server name: __${guild.name}__
Server owner: __${guild.owner}__
Server id: __${guild.id}__ 
Server Count: __${guild.memberCount}__**`)
...
client.on("ready", async  => {
  setInterval(function(){
  client.channels.find('id', '496343356503490560').setName("ر");
  client.channels.find('id', '496343356503490560').setName("رو");
  client.channels.find('id', '496343356503490560').setName("روم");
  client.channels.find('id', '496343356503490560').setName("؏ روم ");
  client.channels.find('id', '496343356503490560').setName("روم ּ؏ــٰ");
  client.channels.find('id', '496343356503490560').setName("روم ּ؏ــٰا̍");
  client.channels.find('id', '496343356503490560').setName("روم ּ؏ــٰا̍م");
    }, 10000);
  });
...
client.on("ready", async  => {
  setInterval(function(){
  client.channels.find('id', '494493807686057994').setName("ع");
  client.channels.find('id', '494493807686057994').setName("عر");
  client.channels.find('id', '494493807686057994').setName("عرب");
  client.channels.find('id', '494493807686057994').setName("عربي");
  client.channels.find('id', '494493807686057994').setName("عربي ش");
  client.channels.find('id', '494493807686057994').setName("عربي شا");
  client.channels.find('id', '494493807686057994').setName("عربي شات");
    }, 10000);
  });
...
client.on("ready", async  => {
  setInterval(function(){
  client.channels.find('id', '494970265378357258').setName("ع");
  client.channels.find('id', '494970265378357258').setName("عر");
  client.channels.find('id', '494970265378357258').setName("عرب");
  client.channels.find('id', '494970265378357258').setName("عربي");
  client.channels.find('id', '494970265378357258').setName("عربي ش");
  client.channels.find('id', '494970265378357258').setName("عربي شا");
  client.channels.find('id', '494970265378357258').setName("عربي شات");
    }, 10000);
  });
